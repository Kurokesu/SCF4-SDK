...
ser = serial.Serial()
ser.port = 'COM2898'             # Controller com port
...
scf4_tools.send_command(ser, "G0 A39700")
scf4_tools.wait_homing(ser, 1, CHA_MOVE)        # Wait until homing is over

scf4_tools.send_command(ser, "G0 B31100")
scf4_tools.wait_homing(ser, 1, CHB_MOVE)        # Wait until homing is over
...
while True:
    ...
    if c.mouse_clicked:
        ...
        scf4_tools.send_command(ser, "G0 B30940")
        ...
        scf4_tools.send_command(ser, "G0 B31360")
