                ...
                while stay_connected:
                    ...
                    if not self.action_recipe.empty():
                        ...
                        if rec == "seek_a":
                            ...
                            self.__ser_send(ser, "G0 A-40000")       # move forward (and move back to find PI to eliminate hysteresis)
                        ...
                        if rec == "seek_b":
                            ...
                            self.__ser_send(ser, "G0 B-40000")       # move forward (and move back to find PI to eliminate hysteresis)
