                ...
                while stay_connected:
                    ...
                    if not self.action_recipe.empty():
                        ...
                        if rec == "init":
                            ...
                            self.__ser_send(ser, "M232 A400 B400 C400 E700 F700 G700")  # Set PI low/high detection voltage
                        ...
                        if rec == "seek_a":
                            ...
                            self.__ser_send(ser, "G0 A-26000")       # move forward (and move back to find PI to eliminate hysteresis)
                        ...
                        if rec == "seek_b":
                            ...
                            self.__ser_send(ser, "G0 B-50000")       # move forward (and move back to find PI to eliminate hysteresis)
